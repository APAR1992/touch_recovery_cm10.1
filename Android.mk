...
TARGET_DEVICE := i727
LOCAL_CFLAGS += -DTARGET_DEVICE_I727 -DTARGET_DEVICE_480

#Samsung Galaxy S2 T-Mobile
else ifeq ($(TARGET_PRODUCT), cm_hercules)
TARGET_DEVICE := t989
LOCAL_CFLAGS += -DTARGET_DEVICE_T989 -DTARGET_DEVICE_480
...
BOARD_RECOVERY_DEFINES := BOARD_HAS_NO_SELECT_BUTTON BOARD_UMS_LUNFILE BOARD_RECOVERY_ALWAYS_WIPES BOARD_RECOVERY_HANDLES_MOUNT BOARD_TOUCH_RECOVERY RECOVERY_EXTEND_NANDROID_MENU TAP_TO_SELECT KYLE_TOUCH_RECOVERY NO_KEYS BOARD_HAS_REMOVABLE_STORAGE
